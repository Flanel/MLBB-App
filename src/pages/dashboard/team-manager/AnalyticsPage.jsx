...
export default function AnalyticsPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      // Build rolling win-rate series (only if real match data exists)
      const mx = matchData || []
      ...
      // Step 3: fetch player stats using actual match IDs (fix: was incorrectly using team_id as match_id)
      ...
      // Tournaments — only show real data
